...
import { CandidateV3DataError, parseCandidateV3Metadata, CANDIDATE_SETTLEMENT_MAX_BYTES } from "./windows-candidate-v3-data.js";
import { parseCandidateV3Record, parseCandidateV3Checkpoint, CANDIDATE_V3_MAX_RECORD_BYTES,
  CANDIDATE_V3_MAX_CHECKPOINT_BYTES } from "./windows-candidate-v3-record.js";
...
const transport = z.object({ domain: z.literal("agent-candidate-inventory-transport/v1"), records: z.array(z.object({
...
export function parseCandidateV3Inventory(wire: unknown, metadataWire: unknown) {
  try {
    ...
    const core = { domain: "agent-candidate-inventory-root/v1" as const, installationId: metadata.installationId,
...
export function parseCandidateV3CheckpointHistory(inventoryWire: unknown, metadataWire: unknown, historyWire: unknown) {
  try {
    ...
    const input = z.object({ domain: z.literal("agent-candidate-checkpoint-history/v1"),
