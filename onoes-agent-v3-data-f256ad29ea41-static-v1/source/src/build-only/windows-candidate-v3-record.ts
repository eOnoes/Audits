...
import { CANDIDATE_V3_DOMAIN, CandidateV3DataError, candidateV3ApprovalIdentity,
...
export function parseCandidateV3Checkpoint(wire: unknown, metadataWire: unknown): CandidateV3Checkpoint {
  ...
  if (value.sequence === 0) {
    ...
    const emptyRoot = canonicalSha256Digest({ domain: "agent-candidate-inventory-root/v1",
