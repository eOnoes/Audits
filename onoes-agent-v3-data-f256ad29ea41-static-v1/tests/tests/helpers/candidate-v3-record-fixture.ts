...
import { CANDIDATE_V3_DOMAIN, CANDIDATE_SETTLEMENT_DOMAIN } from "../../src/build-only/windows-candidate-v3-data.js";
...
export function rebind(value: ReturnType<typeof fixture>): void {
  ...
  checkpointA.inventoryRootDigest = hash({ domain: "agent-candidate-inventory-root/v1", installationId: metadata.installationId,
