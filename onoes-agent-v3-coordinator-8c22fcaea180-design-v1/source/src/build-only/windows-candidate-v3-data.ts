...
export const CANDIDATE_V3_INVENTORY_ROOT_DOMAIN = "agent-candidate-inventory-root/v1" as const;
export const CANDIDATE_V3_INVENTORY_TRANSPORT_DOMAIN = "agent-candidate-inventory-transport/v1" as const;
export const CANDIDATE_V3_CHECKPOINT_HISTORY_DOMAIN = "agent-candidate-checkpoint-history/v1" as const;
