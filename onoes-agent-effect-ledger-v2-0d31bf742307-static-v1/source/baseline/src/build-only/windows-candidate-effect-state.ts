...
export const CANDIDATE_EFFECT_DOMAIN = "agent-candidate-effect-ledger/v1" as const;
...
const common = {
  schemaVersion: z.literal(CANDIDATE_EFFECT_DOMAIN), namespaceId: effectUuid,
...
export function effectApprovalIdentity(intent: CandidateEffectIntent): string {
  return canonicalSha256Digest({ domain: CANDIDATE_EFFECT_DOMAIN, namespaceId: intent.namespaceId, approvalId: intent.approvalId });
}
